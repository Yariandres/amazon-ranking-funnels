...
<body>
  ...
  <div class="container">
    ...
    <div class="hero section-one">
      <div class="grid">
        <div class="col-md-6">
          ...
          <img id="hero-img" src="img/1.jpg" alt="X88B image">
          
          <p class="hero__text letter-spacing">3- All orders are placed right through Amazon, so you are assured a smooth transaction. We will provide you with a private amazon coupon code that allows you to grab this special deal.</p>

          <p class="hero__text letter-spacing">4- Click the button below to have your Amazon coupon emailed to you. You will be provided with step by step instructions on how to grab this deal from amazon today!</p>         
        </div>  

        <div class="col-md-6">
          <h2 class="hero__sub-header">Grab This Insane Amazon.com Deal. This Week Only.</h2>
          
          <p class="hero__text letter-spacing">1- That's right! For a limited time, you can get this top-rated Amazon product at a "15% Off".</p>
          ...
          <img src="img/2.jpg" alt="X88B image">           
        </div>        
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="col">
              ...
              <p>You can only use the coupon code once. You will add one of this item to your amazon shopping cart. When applied, the coupon will allow you
    ...
    <div class="final-img text-center">
      <img id="myImg" src="img/7.jpg" alt="Knife Image">
    </div>
