    ...
    <div class="container">
        ...
        <div class="grid">
          <div class="col-md-6">            
            ...
            <p class="hero__text letter-spacing">
              1- Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione autem sunt voluptates facilis distinctio quisquam hic officiis cupiditate minus, modi, assumenda consectetur soluta amet alias fugiat. Illum quis natus quia.
              
              That's right! For a limited time, you can get this top-rated
              Amazon product at a "30% Off".
            </p>
            
            <p class="hero__text letter-spacing">
              2- Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus provident veritatis repudiandae. Impedit laudantium ipsam similique vitae quos facere nulla tempore qui cumque? Odit adipisci nesciunt, recusandae fugiat non suscipit?
              <!-- The reason this Amazon seller is offering this amazing deal is
              to celebrate the launch of their new product and to generate
              positive word of mouth! -->
            </p>
            <hr>
            <p class="hero__text letter-spacing">
              4- Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae sunt perspiciatis numquam totam ut, alias beatae. Officia explicabo ea, assumenda quas sapiente labore corrupti, non ab ut reprehenderit, eum qui!
              
              <!-- Click the button below to have your Amazon coupon emailed to
          ...
          <img
            ...
            <p class="hero__text letter-spacing">
              3- 
              <!-- All orders are placed right through Amazon, so you are assured
              a smooth transaction. We will provide you with a private amazon
              coupon code that allows you to grab this special deal. -->
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus recusandae enim facere ratione maxime dolor architecto autem laborum cum quasi quaerat repellendus quod dolore nostrum pariatur, mollitia unde possimus incidunt.
            </p> 

          
            

            <img class="" src="https://placeimg.com/640/480/any" alt="Chef Knife By FOXEL" />
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="col">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea magnam placeat illum quisquam. Modi doloribus recusandae at dolorem nemo nisi quaerat corrupti? Quae hic laboriosam quam necessitatibus autem eos assumenda!
            ...
            <div class="col-sm-4">
              <div class="col">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, vitae soluta, ut quasi cupiditate consequuntur excepturi porro nam veniam ab nesciunt eum corrupti natus a dolores id, magnam inventore molestias!
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="col">
                ...
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officiis illum laborum fugit. Vitae et repudiandae, deserunt adipisci, aliquid perferendis accusamus eum nemo qui asperiores quaerat unde, reprehenderit libero odit itaque.
        ...
        <div class="grid">
          <div class="row">
            <div class="imgSection__gallery">
              <div class="col-md-3">
                <div class="col">
                  <img src="https://placeimg.com/640/480/any" alt="Chef Knife By FOXEL" />
                </div>
              </div>
      ...
      <div class="instructions">
        ...
        <p class="letter-spacing">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aut necessitatibus atque, et tempore dignissimos maxime tenetur quia at quaerat nostrum rerum quasi a id, ab perferendis perspiciatis! Nemo, est odit.
        ...
        <p class="letter-spacing">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro rem necessitatibus quae voluptatibus laborum, facilis officiis omnis. Pariatur id libero nulla, fuga unde dolorem. Neque rerum delectus laudantium et excepturi.
      ...
      <div class="final-img text-center">
        <img class="pageImgs" src="https://placeimg.com/640/480/any" alt="Chef Knife By FOXELe" />
      </div>
